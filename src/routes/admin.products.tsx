    ...
    >
      <div className="min-h-full grid place-items-center p-4">
        <form
          ...
          className="bg-background border border-border w-full max-w-3xl p-6 lg:p-8 my-8"
        >
            ...
            <section>
              ...
              <div className="space-y-3">
                {(p.trustBadges ?? []).map((badge, i) => (
                  <div key={i} className="grid sm:grid-cols-[140px_1fr_auto] gap-3 items-end">
                    <Select
                      label="Icon"
                      value={badge.icon}
                    ...
                    <button
                      ...
                      className="text-xs text-destructive pb-2"
                    >
                      Remove
                    </button>
                  </div>
          ...
          {formError && (
            <p className="text-sm text-destructive mt-6" role="alert">
              {formError}
            </p>
          )}
